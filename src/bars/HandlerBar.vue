  ...
  <div class="bar">
    <template v-for="(actionlist, index) in state.actions['default']">
      <template v-for="action in actionlist">
            ...
            <template v-for="groupaction in actiongrouplist">
              <sl-menu-item>
                <component :is="currentAction(`${groupaction}_action`)">
                  <script_action v-if="groupaction.startsWith('scriptor_')" :name="groupaction"></script_action>
                  <custom_action v-else :name="groupaction"></custom_action>
                </component>
              </sl-menu-item>
            </template>
          </div>
        ...
        <component :is="currentAction(`${action}_action`)" v-else>
          <script_action v-if="action.startsWith('scriptor_')" :name="action"></script_action>
          <custom_action v-else :name="action"></custom_action>
        </component>
      </template>
