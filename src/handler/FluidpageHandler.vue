<template>
  ...
  <sl-details v-if="modulesStore.state.loaded && modulesStore.state.modules[module]?.['help_text']" open summary="Info">
...
.fluid-wrap {
  ...
  grid-template-columns:
    [full-start] minmax(20px, 1fr) [main-start] minmax(0, 1200px) [main-end] minmax(20px, 1fr)
    [full-end];
  grid-gap: 20px 0;
  padding: 20px 0;
  overflow-x: auto;
