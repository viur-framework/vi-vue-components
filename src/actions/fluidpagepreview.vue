<template>
  ...
  >
    <div slot="label" class="label-wrapper">
      ...
      <div class="button-wrapper">
        <sl-button-group>
          ...
          <sl-button size="small" title="Tablet Breite 768px" @click="state.currentWidth = '768px'">
            <sl-icon slot="prefix" name="tablet-landscape"></sl-icon>
          </sl-button>
          <sl-button size="small" title="Breite 100%" @click="state.currentWidth = '100%'">
    ...
    <div class="iframe-wrapper">
      <iframe ref="aframe" class="aframe" :src="state.url" :style="{ width: state.currentWidth }"></iframe>
    </div>
  </sl-dialog>
</template>
